...
import { Search, CheckCircle, Eye, FileText, Filter } from 'lucide-react';
...
interface Census {
  ...
  censista?: { nombre: string; username: string };
  certificate?: { id: string; codigoCertificado: string };
}
    ...
    <div className="min-h-screen bg-gray-50 py-6 px-4 sm:px-6 lg:px-8">
      <div className="max-w-7xl mx-auto">
        ...
        <div className="flex flex-col sm:flex-row sm:items-center sm:justify-between mb-6">
          <div>
            <h1 className="text-2xl font-bold text-gray-900">Aprobar Censos</h1>
            <p className="mt-1 text-sm text-gray-600">
              Revisa y aprueba los censos registrados por los censistas
            </p>
          </div>
        </div>
          ...
          <form onSubmit={handleSearch} className="flex flex-col sm:flex-row gap-4">
            ...
            <div className="w-full sm:w-48">
              ...
              >
                ...
                <option value="CERTIFICADO_GENERADO">Con certificado</option>
              </select>
            </div>
          </form>
        </div>
                ...
                censuses.map((census) => (
                  ...
                  >
                    ...
                    <td className="px-6 py-4 whitespace-nowrap text-sm text-gray-600">
                      {census.censista?.nombre || 'N/A'}
                    </td>
                    <td className="px-6 py-4 whitespace-nowrap text-sm text-gray-600">
                      {census.certificate?.codigoCertificado || (
...
export default function AprobarCensosWrapper() {
  return (
    <DashboardWrapper>
      <AprobarCensosPage />
    </DashboardWrapper>
